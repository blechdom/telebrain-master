window.NetworksListView = Backbone.View.extend({
    ...
    render: function () {
        ...
        for (var i = 0; i < modules.length; i++) {
            $('.thumbnails', this.el).append(new NetworksView({model: modules[i]}).render().el);
        }
...
window.NetworksView = Backbone.View.extend({
