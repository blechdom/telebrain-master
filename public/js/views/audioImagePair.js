window.AudioImagePairMasterView = Backbone.View.extend({
    ...
    render: function () {
        if (!this.audioImagePairView) {
            this.audioImagePairView = new AudioImagePairView();
        }
        $(this.el).append(this.audioImagePairView.el);
...
window.AudioImagePairView = Backbone.View.extend({
